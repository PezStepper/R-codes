...
Coppermine.Scaled <- read.delim("H:/PhD Data/BSI/2013-14 Summer Scholarship/PhD/Corrected Field Data/Scale combinations for R/Coppermine Scale Combinations.txt", row.names=1, stringsAsFactors=FALSE)
...
#parameter10 <- as.vector(Coppermine.Scaled.T[1:4,10])
parameter11 <- as.vector(Coppermine.Scaled.T[1:4,11])
parameter12 <- as.vector(Coppermine.Scaled.T[1:4,12])
parameter13 <- as.vector(Coppermine.Scaled.T[1:4,13])
parameter14 <- as.vector(Coppermine.Scaled.T[1:4,14])
parameter15 <- as.vector(Coppermine.Scaled.T[1:4,15])
parameter16 <- as.vector(Coppermine.Scaled.T[1:4,16])
parameter17 <- as.vector(Coppermine.Scaled.T[1:4,17])
