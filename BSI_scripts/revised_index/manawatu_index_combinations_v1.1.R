...
Manawatu.Scaled <- read.delim("Manawatu Scale Combinations.txt", row.names=1, stringsAsFactors=FALSE)
...
write.table(Manawatu.scores, file="Manawatu_scores.txt", sep="\t") #assumes we are saving tot he working directory
