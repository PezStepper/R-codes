...
## with bed movement data. One site is manually left out each time for LOOCV.                              ##
##                                                                                                         ##
## At Import individual site score vectors use a # to leave a site out                                     ##
##                                                                                                         ##
## At bed.movement.T need to leave one row out from bed.movement depending on which site you are leaving   ##
## out                                                                                                     ##
#############################################################################################################
...
setwd("F:/Andrew BSI DATA/Individual Site Scores")
...
# REMEMBER TO LEAVE ONE VALIDATION SITE OUT

setwd("F:/Andrew BSI DATA/LOOCV/Coal Left Out") # change this to the folder you want the output dataframes in
...
bed.movement.T <- t(bed.movement[-10,]) #transpose the data, and drop column i to leave one out
...
#and trace back using the row number to find the combinations of parameter weightings used
